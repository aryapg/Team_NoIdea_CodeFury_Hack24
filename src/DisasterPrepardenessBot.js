...
function DisasterPrepardenessBot() {
  ...
  return (
    ...
    >
      <a href="https://github.com/Vishesh-Pandey/chat-ai" target="_blank" rel="noopener noreferrer">
        <h1 className="text-4xl font-bold text-blue-500 mb-4 animate-bounce">Disaster Preparedness Bot</h1>
      </a>
      <textarea
        required
...
export default DisasterPrepardenessBot;
